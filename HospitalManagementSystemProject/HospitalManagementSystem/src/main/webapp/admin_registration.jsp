...
<div class="container">
    <div class="row" id="login">
        <div class="col-md-5 mx-auto my-5">
            <div class="card mb-2">
                <h4 class="text-center card-header py-1 text-dark fw-bold">ADMIN REGISTRATION</h4>
            </div>
            <div class="card bg-body-secondary">
                <div class="card-body">
                    <form class="" action="${pageContext.request.contextPath}/admin/register" method="post">
                        ...
                        <c:if test="${not empty succMsg}">
                            <div class="row my-2">
                                <p class="text-success text-center fs-6">${succMsg}</p></div>
                            <c:remove var="failMsg"/>
                        </c:if>
                        ...
                        <div class="text-center mt-3" id="signup-text">
                            <a href="" class="text-decoration-none text-dark " id="dontHaveAcc">Already have account
                                ?</a>
                            <a class="text-decoration-none " id="needHelp" href="admin_login.jsp">Login</a>
