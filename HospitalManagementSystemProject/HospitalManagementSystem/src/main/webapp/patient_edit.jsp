    ...
    <nav class="px-lg-5  navbar navbar-expand-lg navbar-dark bg-green">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fs-5 me-2 ">
                    <li class="nav-item ">
    ...
    <div class="row" id="login">
        <div class="col-md-6 mx-auto my-5">
            ...
            <div class="card bg-light">
                <div class="card-body">
                    <form class="fw-bold" action="${pageContext.request.contextPath}/patient/edit" method="post">
                        ...
                        <div class="text-center mt-3" id="signup-text">
                            ...
                            <a class="text-decoration-none " id="needHelp" href="patient_dashboard.jsp">Go Back</a>
