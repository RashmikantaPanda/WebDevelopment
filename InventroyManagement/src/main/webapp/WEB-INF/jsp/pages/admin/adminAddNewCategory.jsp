    ...
    <div class="mx-4">
        <div class="row" id="login">
            <div class="col-md-6 mx-auto my-5">
                <div class="card mb-2">
                    <h4 class="text-center card-header py-1 text-dark fw-bold">ADD
                        NEW CATEGORY</h4>
                </div>
                <div class="card bg-light shadow">
                    <div class="card-body">
                        <form class="fw-bold" action="add_category" method="post"
                            ...
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-4 col-form-label">Category
                                    Code :</label>
                                <div class="col-sm-8 ">
                                    <input type="text" class="form-control" name="categoryCode" required="required">
                                </div>
                            </div>
